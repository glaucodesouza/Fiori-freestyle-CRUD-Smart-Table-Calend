					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cadastro de Materiais v2 (CRUD + Calendar)",
									"targetURL": "#cadmatv2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cadmatv2-display": {
								"semanticObject": "cadmatv2",
								"action": "display",
								"description": "Cadastro de Materiais v2 (CRUD + Calendar)",
								"title": "Cadastro de Materiais v2 (CRUD + Calendar)",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cadmatv2",
									"url": sap.ui.require.toUrl("cadmatv2")
								}
							}
						}
					}
